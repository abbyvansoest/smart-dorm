...
savename = "policies_exp2_max15/policies_hist6_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist6_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist6_third.txt"
runExperiment(filename, hist_length, savename)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp2_max15/policies_hist10_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist10_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist10_third.txt"
runExperiment(filename, hist_length, savename)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp2_max15/policies_hist20_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist20_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist20_third.txt"
runExperiment(filename, hist_length, savename)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp2_max15/policies_hist30_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist30_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist30_third.txt"
runExperiment(filename, hist_length, savename)

hist_length = 40

filename = "experiment_data/first_week.txt"
savename = "policies_exp2_max15/policies_hist40_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist40_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist40_third.txt"
runExperiment(filename, hist_length, savename)

hist_length = 60

filename = "experiment_data/first_week.txt"
savename = "policies_exp2_max15/policies_hist60_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_max15/policies_hist60_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_max15/policies_hist60_third.txt"
runExperiment(filename, hist_length, savename)
