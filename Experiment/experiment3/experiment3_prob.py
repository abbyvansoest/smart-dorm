...
savename = "probabilistic/hist10_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "probabilistic/hist10_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "probabilistic/hist10_third.txt"
runExperiment(filename, hist_length, savename)

hist_length = 15

filename = "experiment_data/first_week.txt"
savename = "probabilistic/hist15_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "probabilistic/hist15_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "probabilistic/hist15_third.txt"
runExperiment(filename, hist_length, savename)

hist_length = 20

filename = "experiment_data/first_week.txt"
savename = "probabilistic/hist20_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "probabilistic/hist20_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "probabilistic/hist20_third.txt"
runExperiment(filename, hist_length, savename)

hist_length = 30

filename = "experiment_data/first_week.txt"
savename = "probabilistic/hist30_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "probabilistic/hist30_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "probabilistic/hist30_third.txt"
runExperiment(filename, hist_length, savename)
