...
def classify(history, hour):
	...
	if (zone1 < zone_avg - dist_from_avg and zone2 < zone1):
		...
		# if the difference is greater than 5, adjust by 1 (or other small number)
			...
			return DECREASING, small_adjust
	...
	if (zone1 > zone_avg + dist_from_avg and zone2 > zone1):
		...
		# if the difference is greater than 5, adjust by 1 (or other small number)
			...
			return INCREASING, small_adjust
...
def runExperiment(datafile, history_length, savename):
	...
	while (entry != ""):
		...
		#	print "i: " + str(i)
			...
			t_split = t.split(":")
			classification, diff = classify(history[i], int(t_split[0]))
			increment = diff * 1
			change = False
...
# savename = "policies_exp2_timecat/policies_hist6_first.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/second_week.txt"
# savename = "policies_exp2_timecat/policies_hist6_second.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/third_week.txt"
# savename = "policies_exp2_timecat/policies_hist6_third.txt"
# runExperiment(filename, hist_length, savename)
...
# filename = "experiment_data/first_week.txt"
# savename = "policies_exp2_timecat/policies_hist10_first.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/second_week.txt"
# savename = "policies_exp2_timecat/policies_hist10_second.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/third_week.txt"
# savename = "policies_exp2_timecat/policies_hist10_third.txt"
# runExperiment(filename, hist_length, savename)
...
# filename = "experiment_data/first_week.txt"
# savename = "policies_exp2_timecat/policies_hist20_first.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/second_week.txt"
# savename = "policies_exp2_timecat/policies_hist20_second.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/third_week.txt"
# savename = "policies_exp2_timecat/policies_hist20_third.txt"
# runExperiment(filename, hist_length, savename)
...
# filename = "experiment_data/first_week.txt"
# savename = "policies_exp2_timecat/policies_hist30_first.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/second_week.txt"
# savename = "policies_exp2_timecat/policies_hist30_second.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/third_week.txt"
# savename = "policies_exp2_timecat/policies_hist30_third.txt"
# runExperiment(filename, hist_length, savename)

# hist_length = 40

# filename = "experiment_data/first_week.txt"
# savename = "policies_exp2_timecat/policies_hist40_first.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/second_week.txt"
# savename = "policies_exp2_timecat/policies_hist40_second.txt"
# runExperiment(filename, hist_length, savename)

# filename = "experiment_data/third_week.txt"
# savename = "policies_exp2_timecat/policies_hist40_third.txt"
# runExperiment(filename, hist_length, savename)

hist_length = 60

filename = "experiment_data/first_week.txt"
savename = "policies_exp2_timecat/policies_hist60_first.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/second_week.txt"
savename = "policies_exp2_timecat/policies_hist60_second.txt"
runExperiment(filename, hist_length, savename)

filename = "experiment_data/third_week.txt"
savename = "policies_exp2_timecat/policies_hist60_third.txt"
runExperiment(filename, hist_length, savename)
