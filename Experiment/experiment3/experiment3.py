...
def classify(history, hour, command):
...
def runExperiment(datafile, history_length, savename, command):
	...
	while (entry != ""):
		...
		#	print "i: " + str(i)
			...
			t_split = t.split(":")
			classification, diff, edited = classify(history, int(t_split[0]), command)
			increment = diff * 1
			change = False
...
savename = "policies_exp3/policies_hist6_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist6_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist6_third.txt"
runExperiment(filename, hist_length, savename, floor)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp3/policies_hist10_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist10_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist10_third.txt"
runExperiment(filename, hist_length, savename, floor)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp3/policies_hist20_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist20_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist20_third.txt"
runExperiment(filename, hist_length, savename, floor)
...
filename = "experiment_data/first_week.txt"
savename = "policies_exp3/policies_hist30_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist30_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist30_third.txt"
runExperiment(filename, hist_length, savename, floor)

hist_length = 40

filename = "experiment_data/first_week.txt"
savename = "policies_exp3/policies_hist40_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist40_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist40_third.txt"
runExperiment(filename, hist_length, savename, floor)

hist_length = 60

filename = "experiment_data/first_week.txt"
savename = "policies_exp3/policies_hist60_first.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/second_week.txt"
savename = "policies_exp3/policies_hist60_second.txt"
runExperiment(filename, hist_length, savename, floor)

filename = "experiment_data/third_week.txt"
savename = "policies_exp3/policies_hist60_third.txt"
runExperiment(filename, hist_length, savename, floor)
